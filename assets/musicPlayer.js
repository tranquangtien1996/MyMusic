// TASK
// 1. XĂ¢y dá»±ng giao diá»‡n -> OK
// 2. Render song -> OK
// 2.1 Xá»­ lĂ½ cuá»™n -> OK
// 3. xá»­ lĂ½ play / pause -> OK
// 4. Xá»­ lĂ½ next / prev -> OK
// 5. Xá»­ lĂ½ thanh tiáº¿n Ä‘á»™ -> OK
// 6. Xá»­ lĂ½ láº·p / random song -> OK
// 7. Focus song Ä‘ang phĂ¡t -> OK
...
class MusicPlayer{
    ...
    constructor(){
        // KhĂ´ng cĂ³ gĂ¬ á»Ÿ Ä‘Ă¢y cáº£, táº¥t cáº£ Ä‘Ă£ Ä‘Æ°á»£c set trong start háº¿t rá»“i!
    }
    config(){
    ...
    set(){
        ...
        //Set width playerMusic
        this.musicPlayer.style.width = window.screen.availWidth +'px';
        // this.musicPlayer.style.width = '300px';
    ...
    // Render song
    renderSong(){
        let html = this.MUSIC_LIST.map((song)=>{
            return `<div class="song">
                        <div class="song-cd cd" style="background-image: url('${song.image}')"></div>
                        <div class="song-info">
    ...
    updateSong(){
        // Update url
        this.audio.src = this.MUSIC_LIST[this.currenIndex].url;
        // Update Cd image
        this.songCd.style.backgroundImage = `url('${this.MUSIC_LIST[this.currenIndex].image}')`;
        // Update name
        this.songName.innerText = this.MUSIC_LIST[this.currenIndex].name;
        // Update Progress
    ...
    handleNext(){
        this.nextBtn.onclick = ()=>{
            if(this.isRandom)
                ...
                this.currenIndex++;
                if(this.currenIndex >= this.MUSIC_LIST.length)
                    this.currenIndex = 0;
            }
        ...
        this.prevBtn.onclick = ()=>{
            if(this.isRandom)
                ...
                if(this.currenIndex < 0)
                    this.currenIndex = this.MUSIC_LIST.length-1;
            }
    ...
    handleRandom(){
        let indexRandom;
        do{
            indexRandom = Math.floor(Math.random() * this.MUSIC_LIST.length);
    ...
    handleEventProgress(){
        ...
        this.songProgress.onmouseup = ()=>{
            ...
            this.songProgress.onmousemove = function(){};
        }
        ...
        this.songProgress.ontouchend = ()=>{
            this.continueUpdateProgress(this.songProgress.value);
            this.songProgress.ontouchmove = function(){};
        }
